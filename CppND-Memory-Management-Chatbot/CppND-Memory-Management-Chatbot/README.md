...
The goal of this project was to optimize the ChatBot program from a memory management perspective. This included:
* Making resources exclusive to a particular class by leveraging smart pointers wherever applicable
* Implementing the Rule of Five
* Applying move semantics to improve the efficiency of the code
